...
const SMPage = () => {
    const features = [
        ...
        },
        {
            ...
            desc: 'Helmet, CSRF, rate limiting, sanitization, validation, and centralized middleware setup.',
        ...
        },
        {
            ...
            desc: 'Frequent updates with security patches, optimizations, and new features.',
    ...
    const releases = [
        ...
        { version: 'v4.0.0-beta1', notes: 'Under development. Use v3.0.0 for production.' },
    ];
        ...
        <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-indigo-50 px-6 pt-32">
            ...
            >
                ...
                <p className="text-lg text-gray-600 mb-4 text-center">
                    <strong>Latest Version:</strong> v4.0.0-beta1 (under development) <br />
                    <strong>Recommended Version:</strong> v3.0.0 (stable & production-ready)
                </p>
                <pre className="bg-gray-900 text-white p-4 rounded-xl text-center overflow-x-auto">
                    npm i secure-mern@3.0.0
                </pre>
                <p className="text-center mt-4">
                    🔗 <a href="https://github.com/BackendExpert/secure-mern/tree/v4.0.0" target="_blank" rel="noopener noreferrer" className="text-indigo-600 font-semibold hover:underline">Development branch (v4.0.0-beta1)</a>
                </p>
            </motion.div>
            ...
            <div className="text-center mb-20">
                ...
                <div className="grid gap-8 md:grid-cols-2 max-w-3xl mx-auto">
                    ...
                    >
                        ...
                        <a
                            href="https://github.com/BlackAlphaLabs/Secure-MERN"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-indigo-600 font-semibold hover:underline"
                        >
